...
/* init array with code that acts like a function wich:
(1) gets a parameter from stack 
(2) increments that value
(3) returns that value */
unsigned char code[] = {0x8B,0x44,0x24,0x04,  /* mov eax, [esp+4] (1) */ 
						0x40,                 /* inc eax          (2) */ 
						0xC3                  /* ret              (3) */ 
					   }; 
...
int main(void) 
{ 
	/* The static code above will be copied to an area alocated with VirtualAlloc 
