...
test_output()
{
	...
	execute_ref "../${REF_FILE}" "${OUT_FILE}"
	# move OUT_DIR in order to preserve the pwd output
	mv ${OUT_DIR} ${REF_DIR}
	execute_mini "../${IN_FILE}" "${OUT_FILE}"
