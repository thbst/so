...
/*
 * SIGSEGV handler - does nothing, successfully
 */

void exception_handler(int signum, siginfo_t *info, void *context)
{
}
...
w_boolean_t w_remove_exception_handler()
{
	if (sigaction(SIGSEGV, &previous_action, NULL) < 0)
		return FALSE;
